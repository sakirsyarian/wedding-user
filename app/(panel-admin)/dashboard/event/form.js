...
export default function FormEvent(props) {
  const eventMain = props.event.main;
  const eventOptional = props.event.optional;
  ...
  const form = useForm({
    ...
    defaultValues: {
      mainHeading: eventMain.mainHeading || "",
      mainDate: new Date(eventMain.mainDate) || undefined,
      mainTimeZone: eventMain.mainTimeZone || "",
      mainTimeStart: eventMain.mainTimeStart || "",
      mainTimeFinish: eventMain.mainTimeFinish || "",
      mainUntilDone: eventMain.mainUntilDone,
      mainLocation: eventMain.mainLocation || "",
      mainAddress: eventMain.mainAddress || "",
      optionalHeading: eventOptional.optionalHeading || "",
      optionalDate: eventOptional.optionalDate
        ? new Date(eventOptional.optionalDate)
        : undefined,
      optionalTimeZone: eventOptional.optionalTimeZone || "",
      optionalTimeStart: eventOptional.optionalTimeStart || "",
      optionalTimeFinish: eventOptional.optionalTimeFinish || "",
      optionalUntilDone: eventOptional.optionalUntilDone,
      optionalLocation: eventOptional.optionalLocation || "",
      optionalAddress: eventOptional.optionalAddress || "",
    },
  });
